...
kafka_config = {
    ...
    'sasl.username': 'UKV5OLU74IRB7KES',#api key
    'sasl.password': 'j1EQsjTwVH3TuWTabZhPYdQls0sOjo6l5WKKe2FcWq8XavBeoVQ30NRbd0MRxHYw' #secret
}

schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-v7vorn.southeastasia.azure.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('BC5TV6FDOW3PT2KF', 'xsdtDhoNas9j2y8vp3JtNaxDGjukIdAmawHfRbdtiAy4GJwLHPaEua+Ewd+psmts')
})
